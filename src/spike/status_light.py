...
class Status_light:
    ISDEBUG = True
    #If LEDSIMULATE is true it writes the state of the Status light LED to the console, if false it changes the state of the LED connected to the LEDPIN
    ISSIMULATION = True
    #The PIN for LED 
    LEDPIN = 0
    #max LED number
    ...
    def __init__(self):
        if(self.ISDEBUG):print("Status light is initialised in debug mode. Simulation:",self.ISSIMULATION, " Maximum LED:",self.MAXLEDNUMBER ," LED ID:",self.LEDID," LED PIN:",self.LEDPIN," change at spike.status_light.py ")
